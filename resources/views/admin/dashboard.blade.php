    ...
    <div class="col-xl-4 col-md-6 col-12">
        <div class="card card-congratulation-medal">
            <div class="card-body">
                ...
                <a  href="{{ route('admin.orders.index' ) }}"  class="btn btn-primary waves-effect waves-float waves-light">View Sales</a>
                <img src="../../assets/app-assets/images/illustration/badge.svg" class="congratulation-medal" alt="Medal Pic">
            </div>
        </div>
    </div>
    <!--/ Medal Card -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                        <div class="d-flex flex-row">
                            ...
                            <div class="my-auto">
                                <h4 class="fw-bolder mb-0">{{$totalProducts}}</h4>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="d-flex flex-row">
                            ...
                            <div class="my-auto">
                                <h4 class="fw-bolder mb-0">${{$ordersSum}}</h4>

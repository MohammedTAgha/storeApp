...
<head>
   ...
   <!--=== All Vendor CSS ===-->
   <link href="{{asset('frontend/assets/css/vendor.css')}}" rel="stylesheet">
   <!--=== Main Style CSS ===-->
                    ...
                    <div class="col-12">
                        <div class="hero-slider-active slick-arrow-style slick-arrow-style_hero slick-dot-style">
                            ...
                            <div class="hero-single-slide">
                                <div class="hero-slider-item bg-img" data-bg="assets/img/slider/slider-1.png">
                            ...
                            <!-- single slider item start -->
                            <div class="hero-single-slide">
                                <div class="hero-slider-item bg-img" data-bg="assets/img/slider/slider-2.png">
                                    <div class="hero-slider-content slide-1">
                ...
                <div class="row no-gutters mtn-30">
                    <div class="col-md-6">
                        <div class="img-container mt-30">
                            <a href="product-details.html">
                                <img src="assets/img/banner/banner-1.png" alt="banner-image">
                            </a>
